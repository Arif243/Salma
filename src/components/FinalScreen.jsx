...
export default function FinalMessageScreen() {
  ...
  const messages = [
    "Hey bestie! 💕",
    "May Allah bless our bond with joy, barakah, and countless memories. 🌙...",
    "Through every laugh, every tear, every crazy adventure...",
    "Your eyes don’t just see — they speak, A language only the heart can seek..🌟",
    "When Allah gives you a friend who brings peace to your heart, you hold onto them with dua, not just words. 🎉",
    ...
    "Happy Friendship Day, my dear Pyari Dost! 💖",
  ];
